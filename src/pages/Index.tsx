...
const Index = () => {
  ...
  if (role !== "landing") {
    ...
    const RoleApp =
      role === "doctor" ? DoctorApp : role === "therapist" ? TherapistApp : NurseApp;
    return (
    ...
    <div className="min-h-screen gradient-mesh">
      ...
      <header className="max-w-7xl mx-auto px-4 sm:px-8 pt-12 pb-8">
        ...
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl sm:text-6xl font-bold tracking-tight text-foreground leading-[1.05] mb-5">
            康复医院<br />
            <span className="bg-clip-text text-transparent gradient-primary">智慧协同</span>
            移动工作台
          </h1>
